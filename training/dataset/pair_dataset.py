...
class pairDataset(DeepfakeAbstractBaseDataset):
    ...
    def __getitem__(self, index):
        ...
        fake_image_trans = self.data_aug(fake_image)
        real_image_trans = self.data_aug(real_image)
        ...
        return {"fake": (fake_image_trans, fake_label, fake_spe_label), 
                "real": (real_image_trans, real_label, real_spe_label)}
    ...
    def collate_fn(batch):
        ...
        Returns:
            ...
            and the mask tensor.
        """
        # Separate the image, label for fake and real data
        fake_images, fake_labels, fake_spe_labels= zip(*[data["fake"] for data in batch])
        real_images, real_labels, real_spe_labels= zip(*[data["real"] for data in batch])

        # Stack the image, label for fake and real data
